...
export default async function InscricaoPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="min-h-screen">
      ...
      {ev.imagem_url && (
        <div className="max-w-[560px] mx-auto px-4 relative z-10 flex justify-center -mt-[150px] pointer-events-none">
      ...
      <div className={`max-w-[560px] mx-auto px-4 relative ${ev.imagem_url ? '-mt-10' : '-mt-12'}`}>
        <div className="card shadow-lift overflow-hidden">
          <div className={`px-8 pb-24 text-center ${ev.imagem_url ? 'pt-12' : 'pt-10'}`}>
